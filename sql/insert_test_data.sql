...
INSERT IGNORE INTO membres (id, nom, prenom, email, telephone, actif)
VALUES 
    (@user_id, CONCAT('User', @user_id), CONCAT('Test', @user_id), CONCAT('user', @user_id, '@example.com'), CONCAT('+1234567890', @user_id), TRUE);
